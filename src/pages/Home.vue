    ...
    <div>
        ...
        <div class="hero-top">
            <div class="body-container">
                <div class="body-move">
                    <p class="body-light text-light">hello there!</p>
                </div>
            </div>
            <div class="body-container">
                <div class="body-move">
                    <p class="body-bold text-light">i'm jeremy chang,</p>
                </div>
            </div>
        </div>
        ...
        <div class="section-container home-goal landing-gsap">
        ...
        <div class="cases-title-container landing-gsap">
        ...
        <div class="selected-work-container landing-gsap">
        ...
        <div class="personal-highlight landing-gsap">
            <div class="col-40">
